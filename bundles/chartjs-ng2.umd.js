(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["chartjs-ng2.umd"] = factory(require("@angular/core"));
	else
		root["chartjs-ng2.umd"] = factory(root["@angular/core"]);
...
var BaseChartDirective = (function () {
    ...
    BaseChartDirective.prototype.refreshZero = function () {
        var _this = this;
        this.ngOnDestroy();
        var datasets = this.getDatasets();
        var options = Object.assign({}, this.options);
        ...
        return new chart_js_1.Chart(this.ctx, opts);
    };
...
var NgChartModule = (function () {
    function NgChartModule() {
    }
    return NgChartModule;
}());
NgChartModule = __decorate([
    core_1.NgModule({
        declarations: [
            BaseChartDirective
        ],
...
exports.NgChartModule = NgChartModule;
...
//# sourceMappingURL=chartjs-ng2.umd.js.map